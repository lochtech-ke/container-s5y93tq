...
> Be patient! In ~3 mins your app is live, at your [app url](https://container-s5y93tq.containers.anotherwebservice.com/). It even has a free SSL/TLS certificate 🔒 you're welcome!
...
Your app will be automatically re-deployed with the latest code at: https://container-s5y93tq.containers.anotherwebservice.com/
...
```
git clone git@github.com:lochtech-ke/container-s5y93tq.git
cd container-s5y93tq
```
...
```
docker attach container-s5y93tq
```
